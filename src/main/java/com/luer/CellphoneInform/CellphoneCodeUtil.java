 ...
 *
 */
public class CellphoneCodeUtil {
    //发送验证码的请求路径URL
    ...
    //短信模板ID
    private static final String TEMPLATEID="9764239";
    //手机号
    private static final String MOBILE="13120892136";
    //验证码长度，范围4～10，默认为4
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * 1.如果是模板验证码，请注意参数mobile是有s的，详细参数配置请参考“发送模板短信文档”
