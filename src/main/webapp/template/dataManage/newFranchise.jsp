    ...
    <div class="container">
        <div class="row">
            ...
            <div class="form-group col-md-5 col-lg-offset-1">
                <label for="companyShort" class="col-md-6 control-label">商户简称：</label>
                <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-5">
                <label for="industryId" class="col-sm-6 control-label">行业分类：</label>
                <div class="col-sm-6">
        ...
        <div class="row">
            <div class="form-group col-md-5">
                <label for="marketingNo" class="col-sm-6 control-label">渠道商英文简称：</label>
                <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-10">
                ...
                <div class="col-sm-9">
                   ...
                   <%-- <input type="text" class="form-control" id="address" name="address" placeholder="企业地址" &lt;%&ndash;disabled&ndash;%&gt;>--%>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-md-5">
                <label for="bankNo" class="col-sm-6 control-label">银行对公账号：</label>
                <div class="col-sm-6">
        ...
        <div class="row">
            <div class="form-group col-md-5">
                <label for="creditCode" class="col-sm-6 control-label">企业信用码/营业执照号：</label>
                <div class="col-sm-6">
