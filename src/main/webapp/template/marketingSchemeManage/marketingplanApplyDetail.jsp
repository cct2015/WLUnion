    ...
    <div class="container" id="container">
        ...
        <div class="row">
            <div class="form-group col-md-5">
                <label for="selLabelNames" class="col-sm-7 control-label" style="width: 139px">标签选择：</label>
                <div class="col-sm-5">
                    <textarea  id="selLabelNames" class="myOtherDescripe" name="selLabelNames" readonly onclick="showMenu();" cols="40" rows="30" placeholder="请选择标签" ></textarea>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <div class="col-sm-5">
                    <textarea type="text" class="comments col-md-10 myOtherDescripe" rows="3" cols="30" id="otherDescripe"
                              name="otherDescripe"/>
                </div>
            </div>
        ...
        <div class="row" >
            <div class="form-group col-md-6" >
                <label for="tell" class="col-md-4 control-label">审核状态：</label>
                <div class="col-sm-5">
