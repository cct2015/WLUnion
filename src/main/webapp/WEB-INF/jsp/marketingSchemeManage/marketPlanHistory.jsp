                ...
                <div class="row">
                    <form id="formSearch" class="form-horizontal" >
                        <div class="form-group" >
                            <label  for="planStatus" class="control-label col-sm-1">方案执行状态:</label>
                            <div class="col-sm-2">
                                <select class="form-control" id="planStatus" name="planStatus" class="selectpicker">
                ...
                <script type="text/javascript">
                    function Query() {
                        ...
                        $("#jqGrid").jqGrid('setGridParam', {
                            url: '${ctx}/marketingPlan/getHistroyMarketingPlanInHQ',
                            postData: {planStatus: planStatus},
                            datatype:'json',
                            page: 1
                        }).trigger("reloadGrid");
                    }
                    ...
                    function init() {
                        $("#jqGrid").jqGrid({
                            ...
                            styleUI: 'Bootstrap',
                            editurl: 'clientArray',
                            postData: {planStatus: status},
                            datatype: "json",
                            rownumbers: true,
                            colNames: ['ID', '方案名称', '方案内容', '所属商户', '开始时间', '结束时间', '使用规则', 'status','planStatus', '方案执行状态', '省', '市', '县', '联系账号', '联系手机', '佣金1', '佣金2', '佣金3', '优惠券', '抵用方式', '券值1', '券值2', '券值3', '活动描述',
                            ...
                            colModel: [
                                ...
                                {name: 'planStatus', index: 'planStatus', width: '80px', hidden: true},
                                {
                                    name: 'ischeck', index: 'ischeck', width: '80px',
                                    formatter: function (grid_id, options, rowObject) {
                                        switch (rowObject.planStatus) {
