...
<div class="right_col" role="main">
    <div class="container body" style="height: 100%; width: 100%;">
        ...
        <%--<div style="display: inline; width: 10px; float: left; margin-left: 10px; font-size: 15px; vertical-align: center; line-height:35px;">--%>
        <%--<div style=" margin-top: 10px; width: 5px;height: 5px;background-color: red;border-radius: 50%;color: #0f0f0f;"></div>--%>
        <%--</div>--%>

        <%--<div style="display: inline; width: 100px; float: left">--%>
        <%--<div style=";margin-left: 10px; width: 80px;font-size: 16px;">订单明细</div>--%>
        <%--</div>--%>

        <%--<div style="display: inline; width: 135px; float: left;background-color: white;">--%>
        <%--<a href="#"--%>
        <%--style=" margin-left: 10px; width: 80px;font-size: 16px;color: red;background-color: white;">设置展示字段</a>--%>
        <%--</div>--%>
        <%--<div style="display: inline; width: 135px; float: left;margin-left: 90%;">--%>
        <%--<button type="button" class="btn btn-danger">导出数据</button>--%>
        <%--</div>--%>
...
<script type="text/javascript">
    $(function () {
        initdatepicker();
        InitGrid();
        $.get("${ctx}/marketingMerchant/selectMerchantByType", function (data) {
