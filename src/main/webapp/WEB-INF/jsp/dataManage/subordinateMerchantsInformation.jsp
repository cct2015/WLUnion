                ...
                <script type="text/javascript">
                    $(document).ready(function () {
                        $("#jqGrid").jqGrid({
                            ...
                            colNames: [
                                ...
                                '国家', '省(直辖市)', '城市', '县(区)', '主营产品', '主营品牌', '商户类别', '商户类别', '收单机构acquirer', '收单机构',
                            ...
                            gridComplete: function () {
                                ...
                                for (var i = 0; i < ids.length; i++) {
                                    var id = ids[i];
                                    var editBtn = "<input type='button'  value='查看' onclick=\"find('" + id + "')\" />";
                    ...
                    var openDialog4Adding = function () {
                        var dialog = BootstrapDialog.show({
                            ...
                            title: "<span style=\"color: #ab8ce4\">新增下级商户</span>",
                            closable: false,
                            draggable: true,
