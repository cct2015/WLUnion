            ...
            <div class="x_content">
                ...
                <script type="text/javascript">
                    $(document).ready(function () {
                        $("#jqGrid").jqGrid({
                            url: '${ctx}/marketingMerchant/selectByTypeAndStep?type=' + 3 + '&step=' + 0,
                            styleUI: 'Bootstrap',
                            editurl: 'clientArray',
                            datatype: "json",
                            rownumbers: true,
                            colNames: [
                                'ID', '总部名称', '企业简称', '商户号','行业Id', '行业类型', '联系人', '联系电话',
                                '国家', '省(直辖市)', '城市', '县(区)', '主营产品', '主营品牌', '商户类别','商户类别',
                                '商户级别', '上级商户id', '上级商', '银行对公账号', '开户名', '开户行', '企业地址', '纳税号',
                            ...
                            colModel: [
                                ...
                                {name: 'address', index: 'address', width: '80px'},
                            ...
                            gridComplete: function () {
                                ...
                                for (var i = 0; i < ids.length; i++) {
                                    var id = ids[i];
                                    var editBtn = "<a href='#' style='color:#f60' onclick=\"find('" + id + "')\"><div style='background-color:blanchedalmond;height:25px;width:70px'>查看详情</div></a>";
                        ...
                        var dialog = BootstrapDialog.show({
                            ...
                            onshown: function () {
                                ...
                                $('#id').val(values.id),
                                    ...
                                    $('#marketingNo').val(values.marketingNo),
                                    $('#faxNo').val(values.faxNo)
                                /*$("#marketingNo").attr("disabled", "disabled");*/
