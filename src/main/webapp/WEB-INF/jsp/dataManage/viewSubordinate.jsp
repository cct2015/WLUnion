            ...
            <div class="x_content">
                ...
                <script type="text/javascript">
                    $(document).ready(function () {
                        $("#jqGrid").jqGrid({
                            url: '${ctx}/marketingMerchant/selectByTypeAndParentId?type=' + 1 + '&parentId=<%=request.getParameter("parentId")%>',
                            styleUI: 'Bootstrap',
                            editurl: 'clientArray',
                            datatype: "json",
                            rownumbers: true,
                            colNames: [
                                'ID', '商户名称', '商户简称', '商户号', '行业Id', '行业名称', '联系人', '联系电话',
                            ...
                            colModel: [
                                ...
                                {name: 'merchantType', index: 'merchantType', width: '80px', hidden: false},
                                {
                            ...
                            gridComplete: function () {
                                ...
                                for (var i = 0; i < ids.length; i++) {
                                    ...
                                    "<a href='#' style='color:#f60' onclick=\"find('" + id + "')\"><div style='background-color:blanchedalmond;height:25px;width:70px'>查看详情</div></a>";
                    ...
                    var openDialog4Updating = function () {
                        ...
                        var dialog = BootstrapDialog.show({
                            type: BootstrapDialog.TYPEer_DEFAULT,
                            title: "<span style=\"color: #ab8ce4\">修改商户信息</span>",
                            closable: false,
                            draggable: true,
                            cssClass: 'login-dialog',
                            message: $('<div></div>').load('${ctx}/template/dataManage/marketingMerchant.jsp'),//加载弹出页面
