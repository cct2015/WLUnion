...
<head>
    ...
    <style>
        ...
        .myImage{
            padding-left: 10%;padding-top: 0%;height: 100px
        }
        tr{
            height: 100px
        }
    ...
    <div class="right_col" role="main" align="center" style="padding-bottom: 0px;height: 100%">
        ...
        <div id="information" style="background-color: rgba(252,252,252,0);margin-top: 0%;margin-left: 5%">
            ...
            <table width="100%" height="500px" style="text-align: center;background-color:#ffffff;border-collapse: separate;">
                <tr  >
                    <td  width="15%">
                        <img class="myImage"  src="${ctx}/static/images/memberNumber.png"/>
                    </td>
                    <td   width="15%" >
                        <div>
                            <label>当前平台会员数：</label>
                ...
                <tr >
                    <td  >
                        <img  class="myImage"  src="${ctx}/static/images/merchantBrandNumber.png"/>
                    </td>
                    <td  >
                ...
                <tr >
                    <td  >
                        <img class="myImage"  src="${ctx}/static/images/wxNumber.png"/>
                ...
                <tr >
                    <td  >
                        <img  class="myImage"  src="${ctx}/static/images/wxFansNumber.png"/>
                    </td>
                    <td  >
                        <div>
                            <label>当前平台粉丝量：</label>
